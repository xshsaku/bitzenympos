          ...
          <table class="table">
             ...
             <tbody>
               ...
               <tr>
                ...
                <td>
                  <input class="form-control" type="text" name="data[{$WORKERS[worker].id}][password]" value="{$WORKERS[worker].password|escape}" size="10" required>
                </td>
                <td>
                  <a href="{$smarty.server.SCRIPT_NAME}?page={$smarty.request.page|escape}&action=download&os=win&id={$WORKERS[worker].id}" class="btn btn-success btn-sm">Win</a>
                  <a href="{$smarty.server.SCRIPT_NAME}?page={$smarty.request.page|escape}&action=download&os=mac&id={$WORKERS[worker].id}" class="btn btn-success btn-sm">Mac</a>
                </td>
